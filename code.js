...
var urlEndpoint = "https://staging.erp.thecobblers.com/xmlrpc/2/object";
...
function dashboardActivity (callback) {
	let urlEndpoint = "https://staging.erp.thecobblers.com/xmlrpc/2/object";

	xmlRpcClient (urlEndpoint, "execute_kw", ['prod-thecobblers-master-e2e-4178176',228,'artisan','res.users','artisan_dashboard_activity',[]], format, function (err, data) {
		if (err) {
			console.log ("err.message == " + err.message);
			tests.stateStruct = false;
			}
